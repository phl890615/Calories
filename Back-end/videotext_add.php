    ...
    <div id="body">
        ...
        <form action="text_add.php" method="post">
            <div class="input-group mb-3">
                ...
                <select name="diet_id" class="form-select" id="inputGroupSelect01">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="phone" readonly value='0900000000' class="form-control" aria-describedby="basic-addon1">
            </div>
            ...
            <div class="input-group mb-3">
                <span style="width:15%" class="input-group-text" id="basic-addon1">需要的食材:</span>
                <textarea name="cont" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
            </div>

            <div class="input-group mb-3">
                <span style="width:15%" class="input-group-text" id="basic-addon1">作法:</span>
                <textarea name="method" class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
            </div>
            ...
            <table class="table table-borderless" style="width: 600px;margin:0 auto">
                <tr>
                    <td>
                        <input class="form-check-input" type="checkbox" name="select_item[]" value="早餐" id="flexCheckChecked">
                        <div>早餐</div>
                    </td>
                    <td>
            ...
            <td><span class="input-group-text" id="basic-addon1">過敏類:</span></td>
            <br />

            <table class="table table-striped">
                <tr>
                    <td>1.麩質類過敏:</td>
                    <td><input type="radio" name="glut" value="1">是</td>
                    <td><input type="radio" name="glut" value="0">否</td>
                </tr>
                <tr>
                    <td>2.奶類過敏:</td>
                    <td><input type="radio" name="milk" value="1">是</td>
                    <td><input type="radio" name="milk" value="0">否</td>
                </tr>
                <tr>
                    <td>3.甲殼類過敏:</td>
                    <td><input type="radio" name="crust" value="1">是</td>
                    <td><input type="radio" name="crust" value="0">否</td>
                </tr>
                <tr>
                    <td>4.魚類過敏:</td>
                    <td><input type="radio" name="fish" value="1">是</td>
                    <td><input type="radio" name="fish" value="0">否</td>
                </tr>
                <tr>
                    <td>5.堅果類過敏:</td>
                    <td><input type="radio" name="nut" value="1">是</td>
                    <td><input type="radio" name="nut" value="0">否</td>
                <tr>
                    <td>6.豆類過敏:</td>
                    <td><input type="radio" name="bean" value="1">是</td>

...
<body>
    ...
    <div id="body">
        ...
        <?php if (!empty($_POST) or !empty($_GET)) : ?>
            ...
            ?>
            <a href="diet_plan.php" title="back"><img src="../picture/back.png" border="0" width="50"></a>
            ...
            <form method="POST" action="diet_planadd.php">
                ...
                <br />
                <br />
                <div style="text-align:right"><input class="btn btn-success" type="submit" name="com" value="修改飲食法" />

                ...
                <div id="body">
                    ...
                    <form action="update_video_revise.php" method="post" name="form" style="width:700px">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="diet_plan" class="form-select" id="inputGroupSelect01">
                        ...
                        <div class="input-group mb-3">
                            <span style="width:15%" class="input-group-text" id="basic-addon1">餐點作法:</span>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select name="fav" class="form-select" id="inputGroupSelect01">
                                <option selected value="<?php echo $re[7]; ?>"><?php if ($re[7] == 0) {
                                                                                    echo "素食";
                                                                                } elseif ($re[7] == 1) {
                                                                                    echo "蛋奶素";
                                                                                } else {
                    ...
                    <table class="table table-borderless" style="width: 500px;margin:0 auto">
                        ...
                        <tr>
                            <td><?php echo "<video width='700' height='360' controls><source src='../video/$re[0].mp4' type='video/mp4'></video>"; ?></td>
                        </tr>
                    </table>
        <?php
        }

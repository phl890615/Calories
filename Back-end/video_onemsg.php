            ...
            <body>
                ...
                <div id="body">
                    <table class="table table-striped" style="width: 700px; margin: 0 auto;padding: 0px;font-family:微軟正黑體;">
                        ...
                        <tr>
                            <td>
                                <p style="font-size: 20px;">需要的食材:</p>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="font-size: 15px;"><?php echo $get_glut ?><?php echo $get_milk ?><?php echo $get_crust ?><?php echo $get_fish ?><?php echo $get_nut ?><?php echo $get_bean ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <form method='post' action='video_msginsert.php'>
                        <div class="input-group mb-3">
                            <input type="text" name="msg" placeholder="請輸入留言..." class="form-control" aria-label="Username" aria-describedby="basic-addon1">
                            <input type="hidden" name="phone" value='09700000000'>
                    ...
                    <form method="POST" action="videos_msgdel.php">
                        <table class="table table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $co[3] ?></td>
                                    <td><?php echo $co[4] ?></td>
                                    <td><?php if ($co[2] == '0900000000') {
                                            echo "<td><a href='video_msg_update.php?id=$co[0]&msg=$co[3]&vid=$co[1]' >修改留言</a></td> ";
                                        } else {
                                            echo '';
                                        } ?></td>
                                <?php
                        ...
                        <input type="button" name="Submit" value="返回" class="btn btn-outline-success" onclick="location.href='video_view.php'" />
                        <input class="btn btn-outline-success" type="submit" name="del" value="刪除留言" onclick="return confirm('確認刪除');" />
                    </form>
        <?php
        }
    }

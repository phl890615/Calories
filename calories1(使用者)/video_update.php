	...
	<div id="page">
		...
		<div align="center">
			<div id="body">
				...
				<form action="video_add_update.php" method="POST" enctype="multipart/form-data" style="width:700px">
					...
					<div class="form-group mb-3">
						...
						<input style='font-size: 19px;' type="button" class="btn btn-outline-success" value="取消" onclick="location.href='video_revise.php?id=<?php echo $_GET['v_id']; ?>'"><br>
					</div>
				</form>

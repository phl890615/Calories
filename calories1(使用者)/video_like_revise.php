...
<body>
	<div id="page">
       ...
       <hr>
                    ...
                    <form action="update_video_like_revise.php" method="post" name="form" style="width:700px">
                    <div class="input-group mb-3">
                                <input style='font-size: 19px;' type="hidden" name="id" readonly="readonly" value="<?php echo $re[0]; ?>" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2"> 
                            </div>
                        ...
                        <div class="input-group mb-3">
                        <label style='font-size: 19px;'class="input-group-text" for="name" class="col-sm-4 col-form-label">餐點簡介:</label>
                            <textarea style='font-size: 19px;' name="cont" class="form-control" id="exampleFormControlTextarea1" rows="3" aria-label="Recipient's username" required aria-describedby="basic-addon2"> <?php echo $re[4]; ?></textarea>
                        </div>

                        <div class="input-group mb-3">
                        <label style='font-size: 19px;' class="input-group-text" for="name" class="col-sm-4 col-form-label">餐點食材:</label>
                        <textarea style='font-size: 19px;' name="method" class="form-control" id="exampleFormControlTextarea1" rows="5" aria-label="Recipient's username" required aria-describedby="basic-addon2"><?php echo $re[5]; ?></textarea>
                        </div>
                        <div class="input-group mb-3">
                ...
                <tr>
                    ...
                    <td><input type="radio" name="bean" value="0" <?php echo $re[13] == 0 ? 'checked' : ''; ?> />否</td>
                        ...
                        <table class="table table-borderless" style="width: 800px;margin:0 auto">
                            ...
                            <input style='font-size: 19px;' type="button" class="btn btn-outline-success" value="取消修改" onclick="location.href='video_like.php'">
                            </div>
                            </tr>
                        </table>
                    </form>
                    <table class="table table-borderless" style="width: 500px;margin:0 auto">
                        ...
                        <tr>
                            <td><button style='font-size: 19px; float: right;' class="btn btn-outline-success" name='v_id' onclick="location.href='video_like_update.php?v_id=<?php echo $re[0]; ?>'">修改影片</button></td>
                        </tr>
                    </table>
        <?php
        }

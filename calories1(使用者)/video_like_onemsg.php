       ...
       <hr>
                    ...
                    <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <textarea style='font-size: 19px;' name="cont" readonly="readonly" class="form-control" rows="4" id="exampleFormControlTextarea1"  row=1 aria-label="Recipient's username" aria-describedby="basic-addon2" ><?php echo $rs[4] ?></textarea>
                                
                            </div>
                    <div class="input-group mb-3">
                                <label style='font-size: 19px;' class="input-group-text" for="name" class="col-sm-4 col-form-label">影片食材:</label>
                                <textarea style='font-size: 19px;' name="cont" readonly="readonly" class="form-control" rows="4" id="exampleFormControlTextarea1"  row=1 aria-label="Recipient's username" aria-describedby="basic-addon2" ><?php echo $rs[5] ?></textarea>
                    ...
                    <form method='post' action='video_msginsert.php' style="width:700px; ">
                    <?php
                        $sql = "SELECT * FROM member WHERE mem_phone ='$mem_phone'"; 
                        ...
                        if($fi[9]==1){
                            ...
                            echo "
                            <div class='input-group mb-3'>
                                <input style='font-size: 19px;' type='text' name='msg' placeholder='請輸入留言...' class='form-control' aria-label='Username' aria-describedby='basic-addon1'>
                                <input style='font-size: 19px;' type='hidden' name='phone' value='$mem_phone'>
                                <input style='font-size: 19px;' type='hidden' name='video_id' value='$rs[0]'>
                ...
                <?php
                        ...
                        <input type="button" name="Submit" value="返回" class='btn btn-outline-success' style='font-size: 19px;' onclick="location.href='video_like.php'" />

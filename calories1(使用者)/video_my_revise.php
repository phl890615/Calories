...
<body>
	<div id="page">
       ...
       <hr>
                    ...
                    <form action="update_video_my_revise.php" method="post" name="form" style="width:700px">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select style='font-size: 19px; height:42.5px;' name="diet_plan" class="form-control" id="inputGroupSelect01">
                        ...
                        <label style='font-size: 19px;'class="input-group-text" for="name" class="col-sm-4 col-form-label">影片簡介:</label>
                            <textarea style='font-size: 19px;' name="cont" class="form-control" id="exampleFormControlTextarea1" rows="3" aria-label="Recipient's username" aria-describedby="basic-addon2" required><?php echo $re[4]; ?> </textarea>
                        </div>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="bean" value="0" <?php echo $re[13] == 0 ? 'checked' : ''; ?> >否</td>
                        ...
                        <table class="table table-borderless" style="width: 800px;margin:0 auto">
                            ...
                            <input style='font-size: 19px; ' type="button" class="btn btn-outline-success" value="取消修改" onclick="location.href='video_my.php'">
                            </div>
                            </tr>
                        </table>
                    </form>
                    <table class="table table-borderless" style="width: 500px;margin:0 auto">
                        ...
                        <tr>
                            <td><button style='font-size: 19px; float:right;' class="btn btn-outline-success" name='v_id' onclick="location.href='video_my_update.php?v_id=<?php echo $re[0]; ?>'">修改影片</button></td>
                        </tr>
                    </table>
        <?php
        }
